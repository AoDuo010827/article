...
public class VersionUtils {
    ...
    public static String getFirmwareDate(String model) {
        String str;
        String reg = "[1-9]\\d{3}(((0[13578]|1[02])([0-2]\\d|3[01]))|((0[469]|11)([0-2]\\d|30))|(02([01]\\d|2[0-8])))";
        if (model.equals("px30_e")) {
            str = Utils.getValueFromProp(Constant.SYSTEM_VERSION_INFO);
            str = str.substring(37, 46);
        } else
            str = Utils.getValueFromProp(Constant.DATE_PROP);
