...
public class YsFactory {
    ...
    public static YS getRK() {
        ...
        else if (product.contains("px30_e") && "27".equals(Build.VERSION.SDK))
            return PX30.INSTANCE;
        ...
        else if (product.contains("rk3568") && "30".equals(Build.VERSION.SDK))
            return RK3568_11.INSTANCE;
        else if (product.contains("rk3566") && "30".equals(Build.VERSION.SDK))
            return RK3568_11.INSTANCE;
        else if (product.contains("x301") && "28".equals(Build.VERSION.SDK))
            return x301.INSTANCE;
        return YS3368_5.INSTANCE;
    }
}
