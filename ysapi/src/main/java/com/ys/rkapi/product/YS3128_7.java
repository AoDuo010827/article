...
//            e.printStackTrace();
//        }
        GPIOUtils.writeStringFileFor7(new File("/sys/class/backlight/rk28_bl/bl_power"),"1");
    }
...
//            e.printStackTrace();
//        }
        GPIOUtils.writeStringFileFor7(new File("/sys/class/backlight/rk28_bl/bl_power"),"0");
    }

    @Override
    public boolean isBackLightOn() {
        return "0".equals(GPIOUtils.readGpioPG("/sys/class/backlight/rk28_bl/bl_power"));
    }
    ...
    @Override
    public void awaken() {
        if ("1".equals(GPIOUtils.readGpioPG("/sys/class/backlight/rk28_bl/bl_power"))) {
            try {
                GPIOUtils.writeIntFileFor7("1","sys/class/display/HDMI/enable");
                GPIOUtils.writeIntFileFor7("0","/sys/class/backlight/rk28_bl/bl_power");
            } catch (IOException e) {
                e.printStackTrace();
            } catch (InterruptedException e) {
                e.printStackTrace();
