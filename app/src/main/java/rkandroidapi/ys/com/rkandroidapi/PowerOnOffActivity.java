    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.set_power_on_time:
                ...
                Log.d("ddddd", "timeonArray:" + Arrays.toString(timeonArray1) + "timeoffArray:" + Arrays.toString(timeoffArray1));
            ...
            case R.id.isSetPowerOnOff:
                ...
                Log.d("Aoduo", "onClick: " + Utils.getValueFromProp("persist.sys.poweronmode"));
                break;
